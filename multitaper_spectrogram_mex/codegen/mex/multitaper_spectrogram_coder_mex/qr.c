...
static emlrtRSInfo qc_emlrtRSI = { 25, /* lineNo */
  "qr",                                /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/qr.m"/* pathName */
};

static emlrtRSInfo rc_emlrtRSI = { 35, /* lineNo */
  "eml_qr",                            /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo sc_emlrtRSI = { 153,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo tc_emlrtRSI = { 161,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo uc_emlrtRSI = { 168,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo vc_emlrtRSI = { 173,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo wc_emlrtRSI = { 174,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo xc_emlrtRSI = { 177,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo yc_emlrtRSI = { 182,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};
...
static emlrtRSInfo bd_emlrtRSI = { 188,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo cd_emlrtRSI = { 189,/* lineNo */
  "qr_econ",                           /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};

static emlrtRSInfo pd_emlrtRSI = { 202,/* lineNo */
  "unpackQR",                          /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pathName */
};
...
static emlrtRSInfo ud_emlrtRSI = { 59, /* lineNo */
  "ceval_xorgqr",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xorgqr.m"/* pathName */
};

static emlrtRTEInfo jc_emlrtRTEI = { 153,/* lineNo */
  6,                                   /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};

static emlrtRTEInfo kc_emlrtRTEI = { 35,/* lineNo */
  9,                                   /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};

static emlrtRTEInfo lc_emlrtRTEI = { 186,/* lineNo */
  5,                                   /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};

static emlrtRTEInfo mc_emlrtRTEI = { 168,/* lineNo */
  5,                                   /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};

static emlrtRTEInfo nc_emlrtRTEI = { 169,/* lineNo */
  5,                                   /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};

static emlrtRTEInfo oc_emlrtRTEI = { 35,/* lineNo */
  25,                                  /* colNo */
  "eml_qr",                            /* fName */
  "/apps/source/matlab/2019b/toolbox/eml/lib/matlab/matfun/private/eml_qr.m"/* pName */
};
        ...
        emxArray_real32_T *R)
{
  ...
  emxInit_real32_T(sp, &b_A, 2, &jc_emlrtRTEI, true);
  st.site = &qc_emlrtRSI;
  b_st.site = &rc_emlrtRSI;
  i = b_A->size[0] * b_A->size[1];
  b_A->size[0] = A->size[0];
  b_A->size[1] = 2;
  emxEnsureCapacity_real32_T(&b_st, b_A, i, &jc_emlrtRTEI);
  ...
  m = b_A->size[0];
  emxInit_real32_T(&b_st, &c_A, 2, &oc_emlrtRTEI, true);
  if (b_A->size[0] > 2) {
    i = R->size[0] * R->size[1];
    R->size[0] = 2;
    R->size[1] = 2;
    emxEnsureCapacity_real32_T(&b_st, R, i, &kc_emlrtRTEI);
    ...
    c_A->size[1] = 2;
    emxEnsureCapacity_real32_T(&c_st, c_A, i, &mc_emlrtRTEI);
    ...
    if (p) {
      i = c_A->size[0] * c_A->size[1];
      c_A->size[1] = 2;
      emxEnsureCapacity_real32_T(&e_st, c_A, i, &mc_emlrtRTEI);
      loop_ub = c_A->size[0];
      for (i = 0; i < loop_ub; i++) {
        c_A->data[i] = rtNaNF;
      }
    ...
    Q->size[0] = c_A->size[0];
    Q->size[1] = 2;
    emxEnsureCapacity_real32_T(&b_st, Q, i, &nc_emlrtRTEI);
    ...
    c_A->size[0] = b_A->size[0];
    c_A->size[1] = 2;
    emxEnsureCapacity_real32_T(&c_st, c_A, i, &lc_emlrtRTEI);
    loop_ub = b_A->size[0] * b_A->size[1];
    for (i = 0; i < loop_ub; i++) {
      c_A->data[i] = b_A->data[i];
    }
    ...
    if (c_A->size[0] != 0) {
      ...
      if (p) {
        i = c_A->size[0] * c_A->size[1];
        c_A->size[1] = 2;
        emxEnsureCapacity_real32_T(&e_st, c_A, i, &lc_emlrtRTEI);
        loop_ub = c_A->size[0];
        for (i = 0; i < loop_ub; i++) {
          c_A->data[i] = rtNaNF;
        }
    ...
    i = Q->size[0] * Q->size[1];
    Q->size[0] = (int8_T)b_A->size[0];
    Q->size[1] = (int8_T)b_A->size[0];
    emxEnsureCapacity_real32_T(&b_st, Q, i, &kc_emlrtRTEI);
