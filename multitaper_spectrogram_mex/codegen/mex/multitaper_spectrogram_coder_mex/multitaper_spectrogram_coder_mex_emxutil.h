 ...
 *
 * multitaper_spectrogram_coder_mex_emxutil.h
 *
 * Code generation for function 'multitaper_spectrogram_coder_mex_emxutil'
 *
 */
...
/* End of code generation (multitaper_spectrogram_coder_mex_emxutil.h) */
