...
static emlrtRSInfo dd_emlrtRSI = { 27, /* lineNo */
  "xgeqrf",                            /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};

static emlrtRSInfo ed_emlrtRSI = { 52, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};

static emlrtRSInfo fd_emlrtRSI = { 53, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};
...
static emlrtRSInfo id_emlrtRSI = { 91, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};

static emlrtRSInfo jd_emlrtRSI = { 94, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};

static emlrtRSInfo kd_emlrtRSI = { 99, /* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};

static emlrtRSInfo ld_emlrtRSI = { 102,/* lineNo */
  "ceval_xgeqrf",                      /* fcnName */
  "/apps/source/matlab/2019b/toolbox/eml/eml/+coder/+internal/+lapack/xgeqrf.m"/* pathName */
};
            ...
            int32_T tau_size[1])
{
  ...
  if (A->size[0] == 0) {
    ...
    if (minmn != 0) {
      ...
      if (minmn != -4) {
        if (minmn == -1010) {
          emlrtErrorWithMessageIdR2018a(&b_st, &l_emlrtRTEI, "MATLAB:nomem",
            "MATLAB:nomem", 0);
        } else {
